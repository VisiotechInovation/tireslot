...
<html lang="en">
  <head>
    ...
    <title>Tierslot Dashboard</title>
    <!-- plugins:css -->
        ...
        <nav class="navbar p-0 fixed-top d-flex flex-row">
          ...
          <div class="navbar-menu-wrapper flex-grow d-flex align-items-stretch">
            ...
            <ul class="navbar-nav navbar-nav-right">
              ...
              <li class="nav-item dropdown border-left">
                <a class="nav-link count-indicator dropdown-toggle" id="notificationDropdown" href="#" data-bs-toggle="dropdown" data-bs-toggle="tooltip" title="Logout">
                  <i class="mdi mdi-logout"></i>
                </a>
              </li>
...
{{-- message --}}
          ...
          <footer class="footer">
            <div class="d-sm-flex justify-content-center justify-content-sm-center">
              <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright © Visiotech Inovation</span>
            </div>
          </footer>
          <!-- partial -->
        </div>
