   ...
   <div class="step__container">
    ...
    <div class="step @if (
        $order->status_id == app('global_order_processing') ||
            $order->status_id == app('global_order_cancelled') ||
            $order->status_id == app('global_order_delivered')) active @endif" data-step="In procesare">2</div>
    <span
     class="step__line @if ($order->status_id == app('global_order_processing')) half @elseif ($order->status_id == app('global_order_delivered') || $order->status_id == app('global_order_cancelled')) full @endif "></span>
