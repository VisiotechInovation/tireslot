...
<?php $component = App\View\Components\Dashboardsidebar::resolve(['active' => __('session')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('sessionstable', ['tableName' => 'user_sessions'])->html();
} elseif ($_instance->childHasBeenRendered('YlJOai5')) {
    $componentId = $_instance->getRenderedChildComponentId('YlJOai5');
    $componentTag = $_instance->getRenderedChildComponentTagName('YlJOai5');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('YlJOai5');
} else {
    $response = \Livewire\Livewire::mount('sessionstable', ['tableName' => 'user_sessions']);
    $html = $response->html();
    $_instance->logRenderedChild('YlJOai5', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php endif; ?>
<?php /**PATH D:\Cloud\Comps\5 - EMBIANZ\1 - Iosif\Embianz\resources\views/admin/session.blade.php ENDPATH**/ ?>