...
<?php $component = App\View\Components\Dashboardsidebar::resolve(['active' => 'labels'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('labelstable')->html();
} elseif ($_instance->childHasBeenRendered('Jt2oXTz')) {
    $componentId = $_instance->getRenderedChildComponentId('Jt2oXTz');
    $componentTag = $_instance->getRenderedChildComponentTagName('Jt2oXTz');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('Jt2oXTz');
} else {
    $response = \Livewire\Livewire::mount('labelstable');
    $html = $response->html();
    $_instance->logRenderedChild('Jt2oXTz', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php endif; ?>
<?php /**PATH D:\Cloud\Comps\5 - EMBIANZ\1 - Iosif\Embianz\resources\views/admin/labels.blade.php ENDPATH**/ ?>