<div class="accordion <?php if($showrelateitems): ?> active <?php endif; ?>">
 ...
 <aside>
  ...
  <div class="aside aside--table <?php if($showTable): ?> active <?php endif; ?>">
   ...
   <nav class="nav--controls">
    <h1 class="table--name">
     <?php echo e(__('Add subcategories')); ?>
   ...
   <div class="table" style="height: calc(100% - 60px);">
      ...
      <tr>
       <th>
        <div class="checkbox--primary">
         <input type="checkbox" id="selectPageadd23" wire:model="selectPageadd" />
         <label for="selectPageadd23"></label>
        </div>
       </th>
       <th>
      ...
      <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
       <tr class="expandable-row">
        <td style="border-left: none" data-title="Check">
         <div class="checkbox--primary">
          <input type="checkbox" value="<?php echo e($category->id); ?>" id="<?php echo e($category->id); ?>" wire:model="checkedadd">
        ...
        <td class="hidden">
         <?php echo e($category->accepted_items); ?>
        ...
        <td>
         <button class="button button--secondary button--sm" wire:click.prevent="confirmItemLink(<?php echo e($category->id); ?>)">
          <svg>
        ...
        <td colspan="3">
         <div class="details">
          ...
          <p>
           ...
           <?php else: ?>
            <div class="checkbox--secondary disabled">
             <input type="checkbox" id="disabled3" disabled>
             <label for="disabled3"></label>
            </div>
           <?php endif; ?>
          </p>
    ...
    <?php if($loadAmount < $categories->total()): ?>
 ...
 <div class="accordion__header">
  <button
   ...
   <?php echo e(__('Subcategories ')); ?>(<?php echo e($relatedsubcats->total()); ?>)
   <svg>
 ...
 <div class="accordion__body">
  ...
  <table class="expandable-table">
   <thead>
    <tr>
     ...
     <?php endif; ?>
     <?php if($this->showColumn('Subcategory Name')): ?>
      <th>
       <button class="table--btn">
        Subcategory Name
        <svg>
     ...
     <?php endif; ?>
     <?php if($this->showColumn('Subcategory Description')): ?>
      <th class="hidden">
       <button class="table--btn">
     ...
     <?php endif; ?>
     <?php if($this->showColumn('Subcategory displayed elements')): ?>
      <th class="hidden">
       <button class="table--btn">
        Subcategory displayed elements
        <svg>
         <polyline points="6 9 12 15 18 9"></polyline>
        </svg>
       </button>
     ...
     <?php endif; ?>
     <?php if($this->showColumn('Subcategory is active?')): ?>
      <th class="hidden">
       <button class="table--btn">
   ...
   <tbody>
    <?php
     $i = 0;
    ?>
    <?php if($relatedsubcats->isEmpty()): ?>
     <tr>
      <td class="table--empty" colspan="<?php echo e(count($columns) + 2); ?>">No record found.</td>
     </tr>
    <?php else: ?>
     <?php $__currentLoopData = $relatedsubcats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $related): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <tr class="expandable-row <?php if($this->isChecked($related->id)): ?> active <?php endif; ?>">
       ...
       <?php if($this->showColumn('Category Name')): ?>
        <td data-title="Name" wire:click="expandRow(<?php echo e($index); ?>)">
         <a href="<?php echo e(route('show_category', ['id' => $category->id])); ?>">
       ...
       <?php if($this->showColumn('Subcategory Name')): ?>
        <td data-title="Name" wire:click="expandRow(<?php echo e($index); ?>)">
         <a href="<?php echo e(route('show_category', ['id' => $related->category->id])); ?>">
          <?php echo e($related->category->name); ?></a>
        </td>
       <?php endif; ?>
       <?php if($this->showColumn('Subcategory Description')): ?>
      ...
      <tr class="details-row  <?php if($rind === $i): ?> active <?php endif; ?>">
       <td colspan="<?php echo e(count($columns) + 2); ?>">
        <div class="details">
         ...
         <?php if($this->showColumn('Subcategory Description')): ?>
          <p>
           <bold>Subcategory Description</bold>
           <?php echo e($related->category->short_description); ?>
         ...
         <?php if($this->showColumn('Subcategory displayed elements')): ?>
          <p>
           <bold>Subcategory displayed elements</bold>
           <?php echo e($related->category->accepted_items); ?>
         ...
         <?php if($this->showColumn('Subcategory is active?')): ?>
          <p>
           <bold>Subcategory is active?</bold>
           <?php if($related->category->active): ?>
            <div class="checkbox--secondary disabled">
  ...
  <?php if($loadAmount < $relatedsubcats->total()): ?>
   <button class="button button--secondary button--fill" style="margin-top: 10px;" wire:click="loadMore">
    Load more
   </button>
  <?php endif; ?>
...
<?php /**PATH D:\Cloud\Comps\5 - EMBIANZ\1 - Iosif\Embianz\resources\views/livewire/related-subcategory.blade.php ENDPATH**/ ?>