...
} elseif ($_instance->childHasBeenRendered('TbSpRCO')) {
    $componentId = $_instance->getRenderedChildComponentId('TbSpRCO');
    $componentTag = $_instance->getRenderedChildComponentTagName('TbSpRCO');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('TbSpRCO');
} else {
    $response = \Livewire\Livewire::mount('store-header');
    $html = $response->html();
    $_instance->logRenderedChild('TbSpRCO', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<main>
...
<?php endif; ?>
<?php /**PATH D:\Cloud\Comps\5 - EMBIANZ\1 - Iosif\Embianz\resources\views/store/404.blade.php ENDPATH**/ ?>