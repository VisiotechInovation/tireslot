...
<?php $component = App\View\Components\Dashboardsidebar::resolve(['active' => __('cart')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('cartstable', ['tableName' => 'carts'])->html();
} elseif ($_instance->childHasBeenRendered('813q4Xa')) {
    $componentId = $_instance->getRenderedChildComponentId('813q4Xa');
    $componentTag = $_instance->getRenderedChildComponentTagName('813q4Xa');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('813q4Xa');
} else {
    $response = \Livewire\Livewire::mount('cartstable', ['tableName' => 'carts']);
    $html = $response->html();
    $_instance->logRenderedChild('813q4Xa', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php endif; ?>
<?php /**PATH D:\Cloud\Comps\5 - EMBIANZ\1 - Iosif\Embianz\resources\views/admin/cart.blade.php ENDPATH**/ ?>