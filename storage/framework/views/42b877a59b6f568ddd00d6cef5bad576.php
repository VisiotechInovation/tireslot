...
<?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('custom-scripts-table', ['tableName' => 'custom_scripts'])->html();
} elseif ($_instance->childHasBeenRendered('WpVX0Ta')) {
    $componentId = $_instance->getRenderedChildComponentId('WpVX0Ta');
    $componentTag = $_instance->getRenderedChildComponentTagName('WpVX0Ta');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('WpVX0Ta');
} else {
    $response = \Livewire\Livewire::mount('custom-scripts-table', ['tableName' => 'custom_scripts']);
    $html = $response->html();
    $_instance->logRenderedChild('WpVX0Ta', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php endif; ?>
<?php /**PATH D:\Cloud\Comps\5 - EMBIANZ\1 - Iosif\Embianz\resources\views/admin/customscripts.blade.php ENDPATH**/ ?>