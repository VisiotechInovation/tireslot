...
<?php $component = App\View\Components\Dashboardsidebar::resolve(['active' => __('price')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('show-pricelist', ['itemId' => ''.e($data->id).''])->html();
} elseif ($_instance->childHasBeenRendered('5CckO39')) {
    $componentId = $_instance->getRenderedChildComponentId('5CckO39');
    $componentTag = $_instance->getRenderedChildComponentTagName('5CckO39');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('5CckO39');
} else {
    $response = \Livewire\Livewire::mount('show-pricelist', ['itemId' => ''.e($data->id).'']);
    $html = $response->html();
    $_instance->logRenderedChild('5CckO39', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php endif; ?>
<?php /**PATH D:\Cloud\Comps\5 - EMBIANZ\1 - Iosif\Embianz\resources\views/admin/show_pricelist.blade.php ENDPATH**/ ?>