...
} elseif ($_instance->childHasBeenRendered('2GAtAO8')) {
    $componentId = $_instance->getRenderedChildComponentId('2GAtAO8');
    $componentTag = $_instance->getRenderedChildComponentTagName('2GAtAO8');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('2GAtAO8');
} else {
    $response = \Livewire\Livewire::mount('store-header');
    $html = $response->html();
    $_instance->logRenderedChild('2GAtAO8', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<main>
...
} elseif ($_instance->childHasBeenRendered('9dHL3fw')) {
    $componentId = $_instance->getRenderedChildComponentId('9dHL3fw');
    $componentTag = $_instance->getRenderedChildComponentTagName('9dHL3fw');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('9dHL3fw');
} else {
    $response = \Livewire\Livewire::mount("store-cart");
    $html = $response->html();
    $_instance->logRenderedChild('9dHL3fw', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php endif; ?>
<?php /**PATH D:\Cloud\Comps\5 - EMBIANZ\1 - Iosif\Embianz\resources\views/store/cart.blade.php ENDPATH**/ ?>