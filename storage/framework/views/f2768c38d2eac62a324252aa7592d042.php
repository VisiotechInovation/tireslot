...
<?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('show-category', ['categoryId' => $data->id])->html();
} elseif ($_instance->childHasBeenRendered('9VGkMoK')) {
    $componentId = $_instance->getRenderedChildComponentId('9VGkMoK');
    $componentTag = $_instance->getRenderedChildComponentTagName('9VGkMoK');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('9VGkMoK');
} else {
    $response = \Livewire\Livewire::mount('show-category', ['categoryId' => $data->id]);
    $html = $response->html();
    $_instance->logRenderedChild('9VGkMoK', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php endif; ?>
<?php /**PATH D:\Cloud\Comps\5 - EMBIANZ\1 - Iosif\Embianz\resources\views/admin/show_category.blade.php ENDPATH**/ ?>