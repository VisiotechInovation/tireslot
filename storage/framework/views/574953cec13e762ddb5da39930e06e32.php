...
<?php endif; ?>
 ...
 <aside>
  <div class="background background--center <?php if($uploadcsv == true): ?> active <?php endif; ?>"></div>
  <div class="aside aside--confirm <?php if($uploadcsv == true): ?> active <?php endif; ?>">
   <span>
 ...
 <h1 class="table--name"><?php echo e(__('Products')); ?> (<?php echo e($products->total()); ?>)</h1>
  ...
  <div class="dropdown dropdown--right display--mobile">
   ...
   <div class="dropdown__content">
    <div class="dropdown__container">
     ...
     <a class="button button--primary button--fill button--flexed" href="<?php echo e(route('add_product')); ?>">
      <svg>
       <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path>
       <polyline points="14 2 14 8 20 8"></polyline>
       <line x1="12" y1="18" x2="12" y2="12"></line>
    ...
    <tr>
     ...
     <?php $__currentLoopData = $selectedColumns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $column): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <?php if($this->showColumn($column)): ?>
       <th <?php if($index > count($selectedColumns) - 19): ?> class="hidden" <?php endif; ?>>
   ...
   <tbody>
    ...
    <?php else: ?>
     <?php
      $i = 0;
     ?>
     <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $nr => $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <tr <?php if($loop->last): ?> id="last_record" <?php endif; ?>
       ...
       <?php $__currentLoopData = $selectedColumns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $column): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <td <?php if($index > count($selectedColumns) - 19): ?> class="hidden" <?php endif; ?> data-title="<?php echo e($column); ?>"
         wire:click="expandRow(<?php echo e($nr); ?>)">
         <?php if($column === 'name'): ?>
          <a href="<?php echo e(route('show_product', ['id' => $product->id])); ?>"><?php echo e($product->name); ?></a>
         <?php elseif($column === 'parent_id'): ?>
          <?php if($product->$column): ?>
           <a href="<?php echo e(route('show_product', ['id' => $product->$column])); ?>"><?php echo e($product->parent->name); ?></a>
          <?php else: ?>
           <?php echo e($product->$column); ?>

          <?php endif; ?>
         <?php elseif($column === 'active' || $column === 'is_new'): ?>
          <?php if($product->$column): ?>
         ...
         <?php elseif($column === 'long_description'): ?>
          <span class="show-less">
           <?php echo $product->$column; ?>

          </span>
         <?php elseif($column === 'comments'): ?>
          <span class="show-less">
           <?php echo $product->$column; ?>
         ...
         <?php elseif($column === 'meta_description'): ?>
          <span class="show-less">
           <?php echo $product->$column; ?>
      ...
      <tr class="details-row  <?php if($row === $i): ?> active <?php endif; ?>">
       <td colspan="17">
        <div class="details">
         <?php $__currentLoopData = $selectedColumns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $column): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <?php if($index >= count($selectedColumns) - 18): ?>
           <p>
            <?php if($column === 'active' || $column === 'is_new'): ?>
             ...
             <?php endif; ?>
            <?php else: ?>
             <bold><?php echo e($column); ?>:</bold> <?php echo e($product->$column); ?>
...
<?php endif; ?>
  ...
  <?php if($loadAmount <= count($products)): ?>
...
<?php /**PATH D:\Cloud\Comps\5 - EMBIANZ\1 - Iosif\Embianz\resources\views/livewire/productstable.blade.php ENDPATH**/ ?>