...
<?php endif; ?>
 ...
 <h1 class="table--name"><?php echo e(__('Categories')); ?> (<?php echo e($categories->total()); ?>)</h1>
  ...
  <div class="dropdown dropdown--right display--mobile">
   ...
   <div class="dropdown__content">
    <div class="dropdown__container">
     ...
     <a class="button button--primary button--fill button--flexed" href="<?php echo e(route('newcategory')); ?>">
      <svg>
       <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path>
       <polyline points="14 2 14 8 20 8"></polyline>
       <line x1="12" y1="18" x2="12" y2="12"></line>
   ...
   <tbody>
    ...
    <?php else: ?>
     <?php
      $i = 0;
     ?>
     <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $nr => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <tr <?php if($loop->last): ?> id="last_record" <?php endif; ?>
       class="expandable-row <?php if($this->isChecked($category->id)): ?> active <?php endif; ?>">
       <td style="border-left: none" data-title="Check">
        <div class="checkbox--primary">
         <input type="checkbox" value="<?php echo e($category->id); ?>" id="<?php echo e($category->id); ?>" wire:model="checked">
       ...
       <?php $__currentLoopData = $selectedColumns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $column): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <td <?php if($index > count($selectedColumns) - 17): ?> class="hidden" <?php endif; ?> data-title="<?php echo e($column); ?>"
         ...
         <?php if($column === 'name'): ?>
          <a href="<?php echo e(route('show_category', ['id' => $category->id])); ?>"><?php echo e(strip_tags($category->name)); ?></a>
         <?php elseif(
             $column === 'active' ||
         ...
         <?php else: ?>
          <?php echo e($category->$column); ?>

         <?php endif; ?>
        </td>
       <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
       <td style="border-right: none">
        <button wire:click.prevent="confirmItemRemoval(<?php echo e($category->id); ?>)"
      ...
      <tr class="details-row  <?php if($row === $i): ?> active <?php endif; ?>">
       <td colspan="18">
        <div class="details">
         <?php $__currentLoopData = $selectedColumns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $column): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <?php if($index >= count($selectedColumns) - 16): ?>
           <?php if($column === 'name'): ?>
            <p>
             <bold><?php echo e($column); ?>:</bold>
             <a href="<?php echo e(route('show_category', ['id' => $category->id])); ?>"><?php echo e($category->name); ?></a>
            </p>
           <?php elseif(
               $column === 'active' ||
                   $column === 'display_variant_price' ||
...
<?php endif; ?>
  ...
  <?php if($loadAmount <= count($categories)): ?>
...
<?php /**PATH D:\Cloud\Comps\5 - EMBIANZ\1 - Iosif\Embianz\resources\views/livewire/categoriestable.blade.php ENDPATH**/ ?>