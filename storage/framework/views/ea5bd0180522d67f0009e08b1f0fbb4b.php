...
<?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('productstable', ['tableName' => 'products'])->html();
} elseif ($_instance->childHasBeenRendered('cS1Jm3n')) {
    $componentId = $_instance->getRenderedChildComponentId('cS1Jm3n');
    $componentTag = $_instance->getRenderedChildComponentTagName('cS1Jm3n');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('cS1Jm3n');
} else {
    $response = \Livewire\Livewire::mount('productstable', ['tableName' => 'products']);
    $html = $response->html();
    $_instance->logRenderedChild('cS1Jm3n', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php endif; ?>
<?php /**PATH D:\Cloud\Comps\5 - EMBIANZ\1 - Iosif\Embianz\resources\views/admin/products.blade.php ENDPATH**/ ?>