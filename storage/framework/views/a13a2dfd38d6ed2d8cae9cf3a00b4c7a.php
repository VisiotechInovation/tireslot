...
<?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('priceliststable', [])->html();
} elseif ($_instance->childHasBeenRendered('afxlxKX')) {
    $componentId = $_instance->getRenderedChildComponentId('afxlxKX');
    $componentTag = $_instance->getRenderedChildComponentTagName('afxlxKX');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('afxlxKX');
} else {
    $response = \Livewire\Livewire::mount('priceliststable', []);
    $html = $response->html();
    $_instance->logRenderedChild('afxlxKX', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php endif; ?>
<?php /**PATH D:\Cloud\Comps\5 - EMBIANZ\1 - Iosif\Embianz\resources\views/admin/pricelists.blade.php ENDPATH**/ ?>