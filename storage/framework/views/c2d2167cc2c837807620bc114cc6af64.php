...
<?php endif; ?>
 ...
 <h1 class="table--name"><?php echo e(__('Price Lists')); ?> (<?php echo e($pricelists->total()); ?>)</h1>
  ...
  <div class="dropdown dropdown--right display--mobile">
   ...
   <div class="dropdown__content">
    <div class="dropdown__container">
     ...
     <a class="button button--primary button--fill button--flexed" href="<?php echo e(route('new_pricelist')); ?>">
      <svg>
       <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path>
       <polyline points="14 2 14 8 20 8"></polyline>
       <line x1="12" y1="18" x2="12" y2="12"></line>
   ...
   <tbody>
    ...
    <?php else: ?>
     <?php
      $i = 0;
     ?>
     <?php $__currentLoopData = $pricelists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $price): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <tr <?php if($loop->last): ?> id="last_record" <?php endif; ?>
       class="expandable-row <?php if($this->isChecked($price->id)): ?> active <?php endif; ?>">
       <td style="border-left: none" data-title="Check">
        <div class="checkbox--primary">
         <input type="checkbox" value="<?php echo e($price->id); ?>" id="<?php echo e($price->id); ?>" wire:model="checked">
         <label for="<?php echo e($price->id); ?>"></label>
        </div>
       </td>
       ...
       <td wire:click="expandRow(<?php echo e($index); ?>)">
        <?php if($this->showColumn('Name')): ?>
         <a href="<?php echo e(route('show_pricelist', ['id' => $price->id])); ?>"><?php echo e($price->name); ?></a>
        <?php endif; ?>
       </td>
       <td wire:click="expandRow(<?php echo e($index); ?>)">
        <?php if($this->showColumn('Currency')): ?>
         <?php echo e($price->currency->name); ?>
       ...
       <td class="hidden">
        <?php if($this->showColumn('Updated At')): ?>
         <?php echo e($price->updated_at); ?>

        <?php endif; ?>
       </td>
       <td style="border-right: none">
        <button wire:click.prevent="confirmItemRemoval(<?php echo e($price->id); ?>)"
...
<?php endif; ?>
  ...
  <?php if($loadAmount <= count($pricelists)): ?>
...
<?php /**PATH D:\Cloud\Comps\5 - EMBIANZ\1 - Iosif\Embianz\resources\views/livewire/priceliststable.blade.php ENDPATH**/ ?>