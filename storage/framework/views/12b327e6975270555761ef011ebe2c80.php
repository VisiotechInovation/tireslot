...
<?php $component = App\View\Components\Dashboardsidebar::resolve(['active' => __('product')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<form class="content" method="POST" enctype="multipart/form-data" action="<?php echo e(route('new_products')); ?>">
 ...
 <section style="height: calc(100% - 107.5px);" class="tabs__content details__view active">
  ...
  <div class="input__tabs">
   <input type="text" name="product_name" placeholder=" " required value="<?php echo e(old('product_name')); ?>">
   <label>Name</label>
  </div>
  ...
  <div class="details__checkboxes">
   ...
   <div class="checkbox__details ">
    <input type="checkbox" id="is_new" name="is_new" value="<?php echo e(old('is_new')); ?>" />
  ...
  <div class="input__tabs">
   <input type="text" name="sku" placeholder=" " required value="<?php echo e(old('sku')); ?>">
   <label>SKU</label>
  </div>

  
  <div class="input__tabs">
   <input type="text" name="ean" placeholder=" " required value="<?php echo e(old('ean')); ?>">
   <label>EAN</label>
  </div>

  
  <div class="input__tabs">
   <input type="number" name="quantity" placeholder=" " value="<?php echo e(old('quantity')); ?>">
   <label>Quantity</label>
  </div>

  
  <div class="input__tabs">
   <input type="number" min="0" placeholder=" " name="popularity" required value="<?php echo e(old('popularity')); ?>">
...
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
   <span class="error <?php $__errorArgs = ['sku'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> active <?php unset($message);
...
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
   <span class="error <?php $__errorArgs = ['ean'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> active <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
  <?php $__errorArgs = ['seo_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
   <span class="error <?php $__errorArgs = ['seo_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> active <?php unset($message);
...
<?php endif; ?>
<?php /**PATH D:\Cloud\Comps\5 - EMBIANZ\1 - Iosif\Embianz\resources\views/admin/add_products.blade.php ENDPATH**/ ?>