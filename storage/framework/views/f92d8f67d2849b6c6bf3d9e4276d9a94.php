...
<?php endif; ?>
 ...
 <h1 class="table--name"><?php echo e(__('Sessions')); ?> (<?php echo e($sessions->total()); ?>)</h1>
    ...
    <tr>
     ...
     <?php $__currentLoopData = $selectedColumns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $column): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <?php if($column == 'payload'): ?>
       <?php continue; ?>
      <?php elseif($this->showColumn($column)): ?>
   ...
   <tbody>
    ...
    <?php else: ?>
     <?php
      $i = 0;
     ?>
     <?php $__currentLoopData = $sessions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $nr => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <tr <?php if($loop->last): ?> id="last_record" <?php endif; ?>
       ...
       <?php $__currentLoopData = $selectedColumns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $column): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <td <?php if($index > 1): ?> class="hidden" <?php endif; ?> data-title="<?php echo e($column); ?>"
         ...
         <?php if($column === 'sessions'): ?>
          <a href="<?php echo e(route('show_session', ['id' => $item->$column])); ?>"><?php echo e($item->$column); ?></a>
         <?php else: ?>
       ...
       <td colspan="17">
        <div class="details">
         <?php $__currentLoopData = $selectedColumns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $column): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <?php if($index > 1): ?>
           <p>
            <bold><?php echo e($column); ?>:</bold><?php echo e($item->$column); ?>
...
<?php endif; ?>
  ...
  <?php if($loadAmount <= count($sessions)): ?>
...
<?php /**PATH D:\Cloud\Comps\5 - EMBIANZ\1 - Iosif\Embianz\resources\views/livewire/sessionstable.blade.php ENDPATH**/ ?>