...
<?php $component = App\View\Components\Dashboardsidebar::resolve(['active' => __('order')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('orderstable', ['tableName' => 'orders'])->html();
} elseif ($_instance->childHasBeenRendered('nzimOM0')) {
    $componentId = $_instance->getRenderedChildComponentId('nzimOM0');
    $componentTag = $_instance->getRenderedChildComponentTagName('nzimOM0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('nzimOM0');
} else {
    $response = \Livewire\Livewire::mount('orderstable', ['tableName' => 'orders']);
    $html = $response->html();
    $_instance->logRenderedChild('nzimOM0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php endif; ?>
<?php /**PATH D:\Cloud\Comps\5 - EMBIANZ\1 - Iosif\Embianz\resources\views/admin/order.blade.php ENDPATH**/ ?>