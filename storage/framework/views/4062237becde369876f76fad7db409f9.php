...
<?php $component = App\View\Components\Dashboardsidebar::resolve(['active' => __('dashboard')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
} elseif ($_instance->childHasBeenRendered('nFUQ1aU')) {
    $componentId = $_instance->getRenderedChildComponentId('nFUQ1aU');
    $componentTag = $_instance->getRenderedChildComponentTagName('nFUQ1aU');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('nFUQ1aU');
} else {
    $response = \Livewire\Livewire::mount('dashboard');
    $html = $response->html();
    $_instance->logRenderedChild('nFUQ1aU', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php endif; ?>
<?php /**PATH D:\Cloud\Comps\5 - EMBIANZ\1 - Iosif\Embianz\resources\views/admin/home.blade.php ENDPATH**/ ?>