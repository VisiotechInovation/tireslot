...
<?php endif; ?>
 ...
 <h1 class="table--name"><?php echo e(__('Orders')); ?> (<?php echo e($orders->total()); ?>)</h1>
    ...
    <tr>
     ...
     <?php $__currentLoopData = $selectedColumns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $column): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <?php if($this->showColumn($column)): ?>
       <th <?php if($index > count($selectedColumns) - 16): ?> class="hidden" <?php endif; ?>>
   ...
   <tbody>
    ...
    <?php else: ?>
     <?php
      $i = 0;
     ?>
     <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $nr => $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <tr <?php if($loop->last): ?> id="last_record" <?php endif; ?>
       ...
       <?php $__currentLoopData = $selectedColumns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $column): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <td <?php if($index > count($selectedColumns) - 16): ?> class="hidden" <?php endif; ?> data-title="<?php echo e($column); ?>"
         ...
         <?php elseif($column === 'payment_id'): ?>
          <?php echo e($order->payment->name); ?>

         <?php elseif($column === 'voucher_id'): ?>
          <?php if($order->voucher_id): ?>
           <?php echo e($order->voucher->code); ?>

          <?php endif; ?>
         <?php else: ?>
          <?php echo e($order->$column); ?>
      ...
      <tr class="details-row  <?php if($row === $i): ?> active <?php endif; ?>">
       <td colspan="17">
        <div class="details">
         <?php $__currentLoopData = $selectedColumns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $column): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <?php if($index >= count($selectedColumns) - 15): ?>
           <?php if($column === 'name'): ?>
            <p>
           ...
           <?php elseif($column === 'account_id'): ?>
            <?php if($order->account_id): ?>
             <p>
              <bold><?php echo e(str_replace('_id', '', $column)); ?>:</bold>
              <a href="<?php echo e(route('show_account', ['id' => $order->account_id])); ?>"><?php echo e($order->account->name); ?></a>
             </p>
            <?php endif; ?>
           <?php elseif($column === 'cart_id'): ?>
...
<?php endif; ?>
  ...
  <?php if($loadAmount <= count($orders)): ?>
...
<?php /**PATH D:\Cloud\Comps\5 - EMBIANZ\1 - Iosif\Embianz\resources\views/livewire/orderstable.blade.php ENDPATH**/ ?>