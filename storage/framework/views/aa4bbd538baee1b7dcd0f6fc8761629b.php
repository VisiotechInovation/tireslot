...
<?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('show-product', ['productId' => $data->id])->html();
} elseif ($_instance->childHasBeenRendered('LiB5VPf')) {
    $componentId = $_instance->getRenderedChildComponentId('LiB5VPf');
    $componentTag = $_instance->getRenderedChildComponentTagName('LiB5VPf');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('LiB5VPf');
} else {
    $response = \Livewire\Livewire::mount('show-product', ['productId' => $data->id]);
    $html = $response->html();
    $_instance->logRenderedChild('LiB5VPf', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php endif; ?>
<?php /**PATH D:\Cloud\Comps\5 - EMBIANZ\1 - Iosif\Embianz\resources\views/admin/show_product.blade.php ENDPATH**/ ?>