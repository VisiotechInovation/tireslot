<div class="accordion <?php if($showmedia): ?> active <?php endif; ?>">
 ...
 <div class="accordion__header">
  <button
   ...
   <?php echo e(__('Media ')); ?>(<?php echo e($category->media->count()); ?>)
   <svg>
 ...
 <aside>
  ...
  <form class="aside aside--table <?php if($medias): ?> active <?php endif; ?>" wire:submit.prevent="savelocal">
        ...
        <td>
         <div class="searchable">
          <input type="number" class="input__searchable" placeholder="Media sequence ex: 1,2..." min="0"
           wire:model.defer="file_sequences.<?php echo e($index); ?>">
         </div>
        </td>
        <td>
   ...
   <div class="table" style="height: calc(100% - 60px);">
    <table class="expandable-table">
     ...
     <tbody>
      ...
      <?php for($i = 0; $i <= $row; $i++): ?>
       <tr class="expandable-row">
        <td style="width: auto !important;" wire:click="expandRow2(<?php echo e($i); ?>)" class="unhidden">
         <?php echo e($i); ?></td>
...
<?php /**PATH D:\Cloud\Comps\5 - EMBIANZ\1 - Iosif\Embianz\resources\views/livewire/related-media-category.blade.php ENDPATH**/ ?>