...
<?php $component = App\View\Components\Dashboardsidebar::resolve(['active' => __('voucher')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('vouchertable', ['tableName' => 'vouchers'])->html();
} elseif ($_instance->childHasBeenRendered('NbFcj3V')) {
    $componentId = $_instance->getRenderedChildComponentId('NbFcj3V');
    $componentTag = $_instance->getRenderedChildComponentTagName('NbFcj3V');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('NbFcj3V');
} else {
    $response = \Livewire\Livewire::mount('vouchertable', ['tableName' => 'vouchers']);
    $html = $response->html();
    $_instance->logRenderedChild('NbFcj3V', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php endif; ?>
<?php /**PATH D:\Cloud\Comps\5 - EMBIANZ\1 - Iosif\Embianz\resources\views/admin/voucher.blade.php ENDPATH**/ ?>