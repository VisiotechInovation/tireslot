...
} elseif ($_instance->childHasBeenRendered('SQBLmu4')) {
    $componentId = $_instance->getRenderedChildComponentId('SQBLmu4');
    $componentTag = $_instance->getRenderedChildComponentTagName('SQBLmu4');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('SQBLmu4');
} else {
    $response = \Livewire\Livewire::mount('store-header');
    $html = $response->html();
    $_instance->logRenderedChild('SQBLmu4', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
<?php
...
} elseif ($_instance->childHasBeenRendered('KwdPAiK')) {
    $componentId = $_instance->getRenderedChildComponentId('KwdPAiK');
    $componentTag = $_instance->getRenderedChildComponentTagName('KwdPAiK');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('KwdPAiK');
} else {
    $response = \Livewire\Livewire::mount('store-main');
    $html = $response->html();
    $_instance->logRenderedChild('KwdPAiK', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php endif; ?>
<?php /**PATH D:\Cloud\Comps\5 - EMBIANZ\1 - Iosif\Embianz\resources\views/store/home.blade.php ENDPATH**/ ?>