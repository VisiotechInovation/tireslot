...
<?php $component = App\View\Components\Dashboardsidebar::resolve(['active' => __('account')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('accountstable', ['tableName' => 'accounts'])->html();
} elseif ($_instance->childHasBeenRendered('E7oVwWq')) {
    $componentId = $_instance->getRenderedChildComponentId('E7oVwWq');
    $componentTag = $_instance->getRenderedChildComponentTagName('E7oVwWq');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('E7oVwWq');
} else {
    $response = \Livewire\Livewire::mount('accountstable', ['tableName' => 'accounts']);
    $html = $response->html();
    $_instance->logRenderedChild('E7oVwWq', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php endif; ?>
<?php /**PATH D:\Cloud\Comps\5 - EMBIANZ\1 - Iosif\Embianz\resources\views/admin/accounts.blade.php ENDPATH**/ ?>