...
} elseif ($_instance->childHasBeenRendered('NDYEInG')) {
    $componentId = $_instance->getRenderedChildComponentId('NDYEInG');
    $componentTag = $_instance->getRenderedChildComponentTagName('NDYEInG');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('NDYEInG');
} else {
    $response = \Livewire\Livewire::mount('dashboard');
    $html = $response->html();
    $_instance->logRenderedChild('NDYEInG', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php endif; ?>
<?php /**PATH D:\tireslot\resources\views/admin/home.blade.php ENDPATH**/ ?>