<div class="accordion <?php if($showrelatedprods): ?> active <?php endif; ?>">
    ...
    <table class="expandable-table">
     ...
     <tbody>
      <?php
       $j = 0;
      ?>
      <?php $__currentLoopData = $prod; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $pro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
       <tr class="expandable-row">
        ...
        <td wire:click="expandRow2(<?php echo e($index); ?>)">
         <?php echo e($prod[$index]['itemselected']); ?>

        </td>

        <td class="hidden">
         <input type="text" required class="input button--fill button--xs"
          wire:model.defer="prod.<?php echo e($index); ?>.product.value">
        </td>
        <td class="hidden">
         <input type="number" required class="input button--fill button--xs"
          wire:model.defer="prod.<?php echo e($index); ?>.product.discount">
        </td>
        <td class="hidden" style="width: auto !important;">
         <input type="number" required class="input button--fill button--xs"
          wire:model.defer="prod.<?php echo e($index); ?>.product.vat">
        </td>
       </tr>
        ...
        <td colspan="3">
         <div class="details">
          <p>
            ...
            <div class="searchable active">
             ...
             <div class="content__searchable">
              <div class="list__searchable">
               <?php if(count($addprods) >= 1): ?>
                <?php $__currentLoopData = $addprods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                 <button class="item__searchable"
                  wire:click.prevent="selectitem(<?php echo e($index); ?>, <?php echo e($pr->id); ?>, '<?php echo e($pr->name); ?>')">
                  <?php echo e($pr->name); ?>
           ...
           <?php else: ?>
            <div class="searchable">
             ...
             <button class="input__searchable">
              <?php if($pro['itemselected']): ?>
               <?php echo e($pro['itemselected']); ?>
           ...
           <?php endif; ?>
           <input type="hidden" wire:model.defer="prod.<?php echo e($index); ?>.product.name">
          </p>
          <p>
           <bold>Value</bold>
          <div class="searchable">
 ...
 <aside>
  <div class="background background--center <?php if($addrelatedproducts): ?> active <?php endif; ?>"></div>
  <div class="aside aside--table <?php if($addrelatedproducts): ?> active <?php endif; ?>">
   ...
   <div class="table" style="height: calc(100% - 60px);">
    <table class="expandable-table">
     ...
     <tbody>
      ...
      <?php $__currentLoopData = $prod; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $pro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
       <tr class="expandable-row">
        <td wire:click="expandRow3(<?php echo e($index); ?>)" style="width: auto !important;">
         <div style="display: flex; align-items: center; justify-content: center;">
          <?php echo e($item->name); ?>
 ...
 <div class="accordion__header">
  <button
   class="button button--flexed button--fill button--primary <?php if($showrelatedprods): ?> button--secondary active <?php endif; ?>"
   wire:click.prevent="<?php if($showrelatedprods === false): ?> $set('showrelatedprods', true) <?php else: ?> $set('showrelatedprods', false) <?php endif; ?>">
   <?php echo e(__('Products ')); ?>(<?php echo e($item->pricelistentries()->count()); ?>)
   <svg>
  ...
  <table class="expandable-table">
    ...
    <tr>
     <th style="border-right: none; border-left: none;">
      <div class="checkbox--primary">
       <input type="checkbox" id="selectPage20" wire:model="selectPage" />
       <label for="selectPage20"></label>
      </div>
     </th>
     ...
     <?php endif; ?>
     <?php if($this->showColumn('Value without Discount')): ?>
      <th class="hidden">
       <button class="table--btn">
     ...
     <?php endif; ?>
     <?php if($this->showColumn('Discount')): ?>
      <th class="hidden">
       <button class="table--btn">
        Discount
        <svg>
     ...
     <?php endif; ?>
     <?php if($this->showColumn('Value without VAT')): ?>
      <th class="hidden">
       <button class="table--btn">
        Value without VAT
        <svg>
   ...
   <tbody>
    <?php
     $i = 0;
    ?>
    <?php if($relatedprods->isEmpty()): ?>
     <tr>
      <td class="table--empty" colspan="<?php echo e(count($columns) + 2); ?>">No record found.</td>
     </tr>
    <?php else: ?>
     <?php $__currentLoopData = $relatedprods; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $prod): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <tr <?php if($loop->last): ?> id="last_record" <?php endif; ?>
       class="expandable-row <?php if($this->isChecked($prod->id)): ?> active <?php endif; ?>">
       <td style="border-left: none" data-title="Check">
        <div class="checkbox--primary">
         <input type="checkbox" value="<?php echo e($prod->id); ?>" id="<?php echo e($prod->id); ?>" wire:model="checked">
         <label for="<?php echo e($prod->id); ?>"></label>
        </div>
       </td>

       <?php if($this->showColumn('Id')): ?>
        <td wire:click="expandRow(<?php echo e($index); ?>)"><?php echo e($prod->id); ?></td>
       <?php endif; ?>
       <?php if($this->showColumn('Name')): ?>
        <td>
         <a href="<?php echo e(route('show_product', ['id' => $prod->product->id])); ?>">
          <?php echo e($prod->product->name); ?>
       ...
       <?php if($this->showColumn('Currency')): ?>
        <td class="hidden" wire:click="expandRow(<?php echo e($index); ?>)">
         <?php echo e($prod->pricelist->currency->name); ?>

        </td>
       <?php endif; ?>
       <?php if($this->showColumn('Value')): ?>
        <td class="hidden" wire:click="expandRow(<?php echo e($index); ?>)">
         <?php echo e($prod->value); ?>

        </td>
       <?php endif; ?>
       <?php if($this->showColumn('Value without Discount')): ?>
        <td class="hidden" wire:click="expandRow(<?php echo e($index); ?>)">
         <?php echo e($prod->value_no_discount); ?>
       ...
       <?php if($this->showColumn('Discount')): ?>
        <td class="hidden">
         ...
         <?php else: ?>
          <div class="searchable">
           <input type="number"class="input__searchable" wire:model.defer="product.<?php echo e($index); ?>.discount">
          </div>
         <?php endif; ?>
        </td>
       <?php endif; ?>
       <?php if($this->showColumn('Value without VAT')): ?>
        <td class="hidden">
         <?php if($editedrow !== $index): ?>
          <?php echo e($prod->value_no_vat); ?>

         <?php else: ?>
          <div class="searchable">
           <input type="number"class="input__searchable" wire:model.defer="product.<?php echo e($index); ?>.value">
          </div>
         <?php endif; ?>
        </td>
       <?php endif; ?>
       <?php if($this->showColumn('VAT')): ?>
        <td class="hidden">
         ...
         <?php else: ?>
          <div class="searchable">
           <input type="number"class="input__searchable" wire:model.defer="product.<?php echo e($index); ?>.vat">
          </div>
         <?php endif; ?>
        </td>
       <?php endif; ?>
       <td class="hidden" wire:click="expandRow(<?php echo e($index); ?>)">
        <?php echo e($prod->created_at); ?>

       </td>
       <td class="hidden" wire:click="expandRow(<?php echo e($index); ?>)">
        <?php echo e($prod->updated_at); ?>
        ...
        <div style="display: flex;">
         <?php if($editedrow !== $index): ?>
          <button class="button button--secondary button--sm"
           wire:click.prevent="edititem(<?php echo e($prod->id); ?>, <?php echo e($prod->product->id); ?>, <?php echo e($index); ?>)">
           <svg>
          ...
          <button class="button button--secondary button--sm"
           wire:click.prevent="confirmItemRemoval(<?php echo e($prod->id); ?>)">
           <svg>
            <polyline points="3 6 5 6 21 6"></polyline>
            <path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path>
           </svg>
         ...
         <?php else: ?>
          <button class="button button--secondary button--sm"
           wire:click.prevent="confirmitem(<?php echo e($index); ?>,<?php echo e($prod->id); ?>)">
           <svg>
      ...
      <tr class="details-row  <?php if($rind === $i): ?> active <?php endif; ?>">
       <td colspan="<?php echo e(count($columns) + 2); ?>">
        <div class="details">
         ...
         <?php if($this->showColumn('Value without Discount')): ?>
          <p>
           <bold>Value without Discount</bold>
           <?php echo e($prod->value_no_discount); ?>
...
<?php /**PATH D:\Cloud\Comps\5 - EMBIANZ\1 - Iosif\Embianz\resources\views/livewire/related-productson-pricelist.blade.php ENDPATH**/ ?>