...
} elseif ($_instance->childHasBeenRendered('l4241841903-0')) {
    $componentId = $_instance->getRenderedChildComponentId('l4241841903-0');
    $componentTag = $_instance->getRenderedChildComponentTagName('l4241841903-0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l4241841903-0');
} else {
    $response = \Livewire\Livewire::mount('wishlist-quantity');
    $html = $response->html();
    $_instance->logRenderedChild('l4241841903-0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
      <svg>
...
} elseif ($_instance->childHasBeenRendered('l4241841903-1')) {
    $componentId = $_instance->getRenderedChildComponentId('l4241841903-1');
    $componentTag = $_instance->getRenderedChildComponentTagName('l4241841903-1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l4241841903-1');
} else {
    $response = \Livewire\Livewire::mount('cart-quantity', ['cart' => $cart]);
    $html = $response->html();
    $_instance->logRenderedChild('l4241841903-1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
      <?php endif; ?>
...
} elseif ($_instance->childHasBeenRendered('l4241841903-2')) {
    $componentId = $_instance->getRenderedChildComponentId('l4241841903-2');
    $componentTag = $_instance->getRenderedChildComponentTagName('l4241841903-2');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l4241841903-2');
} else {
    $response = \Livewire\Livewire::mount('general-search');
    $html = $response->html();
    $_instance->logRenderedChild('l4241841903-2', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('l4241841903-3')) {
    $componentId = $_instance->getRenderedChildComponentId('l4241841903-3');
    $componentTag = $_instance->getRenderedChildComponentTagName('l4241841903-3');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l4241841903-3');
} else {
    $response = \Livewire\Livewire::mount('cart-products-list');
    $html = $response->html();
    $_instance->logRenderedChild('l4241841903-3', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('l4241841903-4')) {
    $componentId = $_instance->getRenderedChildComponentId('l4241841903-4');
    $componentTag = $_instance->getRenderedChildComponentTagName('l4241841903-4');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l4241841903-4');
} else {
    $response = \Livewire\Livewire::mount('wishlist-products-list');
    $html = $response->html();
    $_instance->logRenderedChild('l4241841903-4', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
 <!----------------------Menu (Leftbar)---------------------->
...
<?php /**PATH D:\Cloud\Comps\5 - EMBIANZ\1 - Iosif\Embianz\resources\views/livewire/store-header.blade.php ENDPATH**/ ?>