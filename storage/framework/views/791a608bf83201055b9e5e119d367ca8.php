...
<?php $component = App\View\Components\Dashboardsidebar::resolve(['active' => 'store_settings'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('storesettingstable')->html();
} elseif ($_instance->childHasBeenRendered('oFXusMv')) {
    $componentId = $_instance->getRenderedChildComponentId('oFXusMv');
    $componentTag = $_instance->getRenderedChildComponentTagName('oFXusMv');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('oFXusMv');
} else {
    $response = \Livewire\Livewire::mount('storesettingstable');
    $html = $response->html();
    $_instance->logRenderedChild('oFXusMv', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php endif; ?>
<?php /**PATH D:\Cloud\Comps\5 - EMBIANZ\1 - Iosif\Embianz\resources\views/admin/store_settings.blade.php ENDPATH**/ ?>