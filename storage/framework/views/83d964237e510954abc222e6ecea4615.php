<div class="accordion <?php if($showrelatedprod): ?> active <?php endif; ?>">
 ...
 <div class="accordion__header">
  <button
   ...
   <?php echo e(__('Cart Items ')); ?>(<?php echo e($cart->cartitems->count()); ?>)
   <svg>
 ...
 <div class="accordion__body">
  ...
  <table class="expandable-table">
   <thead>
    <tr>
     ...
     <?php if($this->showColumn('Created At')): ?>
      <th class="hidden">
       <button wire:click="sortBy('created_at')" class="table--btn <?php if($productBy === $column && $productAsc === '1'): ?> active <?php endif; ?>">
        Created At
        <svg>
         <polyline points="6 9 12 15 18 9"></polyline>
        </svg>
   ...
   <tbody>
    ...
    <?php else: ?>
     <?php $__currentLoopData = $cartproducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH D:\Cloud\Comps\5 - EMBIANZ\1 - Iosif\Embianz\resources\views/livewire/related-cart-items.blade.php ENDPATH**/ ?>