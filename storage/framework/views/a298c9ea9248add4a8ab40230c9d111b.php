...
<?php $component = App\View\Components\Dashboardsidebar::resolve(['active' => __('brand')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('brandstable', ['tableName' => 'brands'])->html();
} elseif ($_instance->childHasBeenRendered('HkbJaCx')) {
    $componentId = $_instance->getRenderedChildComponentId('HkbJaCx');
    $componentTag = $_instance->getRenderedChildComponentTagName('HkbJaCx');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('HkbJaCx');
} else {
    $response = \Livewire\Livewire::mount('brandstable', ['tableName' => 'brands']);
    $html = $response->html();
    $_instance->logRenderedChild('HkbJaCx', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php endif; ?>
<?php /**PATH D:\Cloud\Comps\5 - EMBIANZ\1 - Iosif\Embianz\resources\views/admin/brands.blade.php ENDPATH**/ ?>