...
<?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('promotiontable', ['tableName' => 'promotions'])->html();
} elseif ($_instance->childHasBeenRendered('XA7eFyd')) {
    $componentId = $_instance->getRenderedChildComponentId('XA7eFyd');
    $componentTag = $_instance->getRenderedChildComponentTagName('XA7eFyd');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('XA7eFyd');
} else {
    $response = \Livewire\Livewire::mount('promotiontable', ['tableName' => 'promotions']);
    $html = $response->html();
    $_instance->logRenderedChild('XA7eFyd', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php endif; ?>
<?php /**PATH D:\Cloud\Comps\5 - EMBIANZ\1 - Iosif\Embianz\resources\views/admin/promotions.blade.php ENDPATH**/ ?>