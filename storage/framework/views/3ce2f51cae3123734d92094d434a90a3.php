...
<?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('show-order', ['orderId' => $data->id])->html();
    ...
    $response = \Livewire\Livewire::mount('show-order', ['orderId' => $data->id]);
    $html = $response->html();
...
<?php endif; ?>
<?php /**PATH D:\Cloud\Comps\5 - EMBIANZ\1 - Iosif\Embianz\resources\views/admin/show_order.blade.php ENDPATH**/ ?>