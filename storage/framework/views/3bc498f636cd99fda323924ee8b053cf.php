...
} elseif ($_instance->childHasBeenRendered('9WgKFH0')) {
    $componentId = $_instance->getRenderedChildComponentId('9WgKFH0');
    $componentTag = $_instance->getRenderedChildComponentTagName('9WgKFH0');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('9WgKFH0');
} else {
    $response = \Livewire\Livewire::mount('categoriestable', ['tableName' => 'categories']);
    $html = $response->html();
    $_instance->logRenderedChild('9WgKFH0', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php endif; ?>
<?php /**PATH D:\Cloud\Comps\5 - EMBIANZ\1 - Iosif\Embianz\resources\views/admin/category.blade.php ENDPATH**/ ?>