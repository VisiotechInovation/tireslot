...
<?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('show-script', ['scriptId' => $data->id])->html();
} elseif ($_instance->childHasBeenRendered('wMLLAZw')) {
    $componentId = $_instance->getRenderedChildComponentId('wMLLAZw');
    $componentTag = $_instance->getRenderedChildComponentTagName('wMLLAZw');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('wMLLAZw');
} else {
    $response = \Livewire\Livewire::mount('show-script', ['scriptId' => $data->id]);
    $html = $response->html();
    $_instance->logRenderedChild('wMLLAZw', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php endif; ?>
<?php /**PATH D:\Cloud\Comps\5 - EMBIANZ\1 - Iosif\Embianz\resources\views/admin/show_script.blade.php ENDPATH**/ ?>