...
<?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('show-session', ['sessionId' => $data->id])->html();
} elseif ($_instance->childHasBeenRendered('PS2EtOT')) {
    $componentId = $_instance->getRenderedChildComponentId('PS2EtOT');
    $componentTag = $_instance->getRenderedChildComponentTagName('PS2EtOT');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('PS2EtOT');
} else {
    $response = \Livewire\Livewire::mount('show-session', ['sessionId' => $data->id]);
    $html = $response->html();
    $_instance->logRenderedChild('PS2EtOT', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php endif; ?>
<?php /**PATH D:\Cloud\Comps\5 - EMBIANZ\1 - Iosif\Embianz\resources\views/admin/show_session.blade.php ENDPATH**/ ?>